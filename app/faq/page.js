      ...
      <motion.header className="text-center mb-12 sm:mb-16 md:mb-20">
        ...
        >
          <Link
            ...
            className="bg-black text-white px-6 py-3 rounded-full inline-flex items-center gap-2 hover:scale-105 hover:shadow-lg hover:cursor-pointer hover:bg-gray-800 transition-colors duration-300"
          >
